package com.subh.user.service.config;

import com.subh.user.service.config.interceptor.RestTemplateInterceptor;
...
public class UserConfigurations {
    ...
    public RestTemplate restTemplate(){
        // now will comment this and create resttemplate with interceptors
